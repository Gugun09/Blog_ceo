...
class PostController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('success','Data berhasil Dihapus (Silhkan Cek trashPost)');
    }
    ...
    public function restore($id)
    {
        ...
        return redirect()->back()->with('success','Data berhasil Direstore (Silhkan Cek listPost)');
    }
    ...
    public function kill($id)
    {
       $post = Posts::withTrashed()->where('id', $id)->first();
        ...
        return redirect()->back()->with('success','Data berhasil Di Kill Permanen');
    }
}
